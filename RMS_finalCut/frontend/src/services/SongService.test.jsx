...
describe("SongService API", () => {
  ...
  //  ADD SONG
  test("addSong should successfully add a new song", async () => {
  ...
  test("addSong should throw an error if the song already exists (409 Conflict)", async () => {
  ...
  test("addSong should throw a generic error on server failure", async () => {
  ...
  test("fetchSongsByArtist should return a list of songs for the given artist", async () => {
    const artistId = 5;
  ...
  test("fetchSongsByArtist should return an empty array if no songs are found", async () => {
    const artistId = 5;
  ...
  test("fetchSongsByArtist should throw an error on failure", async () => {
    const artistId = 5;
  ...
  //  DELETE SONG
  test("deleteSong should successfully delete a song", async () => {
    const songId = 10;
  ...
  test("deleteSong should throw an error if songId is invalid", async () => {
  ...
  test("deleteSong should handle server errors", async () => {
    const songId = 10;
