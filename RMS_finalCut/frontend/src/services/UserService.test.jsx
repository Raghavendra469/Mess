...
describe("UserService API Tests", () => {
  ...
  it("should create a user successfully", async () => {
    ...
    expect(axios.post).toHaveBeenCalledWith("http://3.223.75.62:5005/api/users", expect.any(Object), headers);
  });
  ...
  it("should fetch user details successfully", async () => {
    ...
    expect(axios.get).toHaveBeenCalledWith("http://3.223.75.62:5005/api/users/testUser", headers);
  });
  ...
  it("should update user profile successfully", async () => {
    ...
    expect(result).toEqual({ success: true, user: mockUser });
    expect(axios.put).toHaveBeenCalledWith("http://3.223.75.62:5005/api/users/testUser", mockUser, headers);
  });
  ...
  it("should fetch users by role successfully", async () => {
    ...
    expect(result).toEqual([mockUser]);
    expect(axios.get).toHaveBeenCalledWith("http://3.223.75.62:5005/api/users/role/manager", headers);
  });
  ...
  it("should activate user successfully", async () => {
    ...
    expect(result).toEqual(mockUser);
    expect(axios.put).toHaveBeenCalledWith("http://3.223.75.62:5005/api/users/toggle/1", { isActive: true }, headers);
  });
  ...
  it("should deactivate user successfully", async () => {
    ...
    expect(result).toEqual(mockUser);
    expect(axios.put).toHaveBeenCalledWith("http://3.223.75.62:5005/api/users/toggle/1", { isActive: false }, headers);
  });
