...
const mockSetSelectedRoyalty = jest.fn();
...
describe("CreateTransactionForm Component", () => {
  ...
  test("validates input and prevents invalid transaction submission", async () => {
    render(
      <CreateTransactionForm
        selectedRoyalty={selectedRoyalty}
        setSelectedRoyalty={mockSetSelectedRoyalty}
  ...
  test("calls setSelectedRoyalty when clicking Cancel", () => {
    render(
      <CreateTransactionForm
        selectedRoyalty={selectedRoyalty}
        setSelectedRoyalty={mockSetSelectedRoyalty}
